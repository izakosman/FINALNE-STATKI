...
def statkigen():
        ...
        def four(self):
            ...
            if pozpion == 0:
                ...
                if x3 > 9:
                    ...
                    if self.plansza[y, x] == 0 and self.plansza[y, x1] == 0 and self.plansza[y, x2] == 0 and self.plansza[
                        y, x3] == 0:
                        self.plansza[y, x] = 4
                        self.plansza[y, x1] = 4
                        self.plansza[y, x2] = 4
                ...
                if y3 > 9:
                    ...
                    if self.plansza[y, x] == 0 and self.plansza[y1, x] == 0 and self.plansza[y2, x] == 0 and self.plansza[
                        y3, x] == 0:
                        self.plansza[y, x] = 4
                        self.plansza[y1, x] = 4
                        self.plansza[y2, x] = 4
    ...
    if __name__ == "__main__":
        ...
        Gracz.generator()
        print(Gracz.plansza)
        np.save('GRACZ_STATKI', Gracz.plansza)
